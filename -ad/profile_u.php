                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                                            ...
                                            ?>
                                                <img id="blah" alt="user-avatar" class="d-block rounded profile" height="100" width="100" id="uploadedAvatar" src="includes/data/images/<?php echo $Image_Name ?>">

                                            <?php
                                            } else {
                                            ?>
                                                <img id="blah" src="../assets/img/avatars/6.png" alt="user-avatar" class="profile d-block rounded" height="100" width="100" id="uploadedAvatar">
                                            <?php
                                     ...
                                     <form id="formAccountSettings" method="POST" onsubmit="return false">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <br/>
                                                        <input type="text" id="Account_Name" name="Account_Name" class="form-control" value="<?php echo $Account_Name ?>" placeholder="<?php echo $Account_Name ?>">
