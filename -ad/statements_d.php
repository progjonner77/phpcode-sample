                ...
                <table class="table card-table table-hover td.dt-control table-bordered table-striped" id="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    ?>
                        ...
                        <tr data="<tr><td>Amount:</td><td><?php echo $amount ?></td></tr>
                        <tr><td>Crypto Equivalent:</td><td><?php echo $crypto_name . " " . $coin ?></td></tr>
                        <tr><td>Crypto Address:</td><td><?php echo $address ?></td></tr>
                        <tr><td>Transaction reference:</td><td><?php echo $reference ?></td></tr>
                        <tr><td>Admin Remark:</td><td><?php echo $remark ?></td></tr>">
                          ...
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="<?php echo $name?>">
                          ...
                          <td>
                            ...
                            <?php } elseif ($status == "Confirmed") { ?>
                              <span class="badge bg-label-info  me-1">Confirmed</span>

                            <?php } elseif ($status == "Under Paid") { ?>
                              <span class="badge bg-label-success  me-1">Under Paid</span>
                            <?php } ?>
                          </td>
                          <td>
                            <?php echo $reference ?>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="row mb-3">
                        <div class="col mb-0">
                          ...
                          <input type="text" name="name" id="name" class="form-control" placeholder="Sender Name">
                        </div>
                        <div class="col mb-0">
                    ...
                    <div class="row">
                      <div class="row mb-3">
                        ...
                        <div class="col mb-0">
                          <label for="Date" class="form-label"> Date</label> <input type="text" name="date" id="date" class="form-control" placeholder="2023:05:10">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="row mb-3">
                        <div class="col mb-0">
                          ...
                          <input type="text" name="crypto_name" id="crypto_name" class="form-control" placeholder="Enter More info">
                        </div>
                        <div class="col mb-0">
                          <label for="coin" class="form-label">Coin name</label>
                          <input type="text" name="coin" id="coin" class="form-control" placeholder="Coin name">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="row mb-3">
                        <div class="col mb-0">
                          <label for="nameBackdrop" class="form-label">Admin Crypto Address</label>
                          <input type="text" name="address" id="address" class="form-control" placeholder="Crypto Address">
                        </div>
                        <div class="col mb-0">
                          <input type="text" hidden name="id" id="id">
                          <label for="Ben_Accno" class="form-label">Remark From You</label>
                    ...
                    <!-- <div class="row">
                      <div class="row mb-3">
                        ...
                        <div class="col mb-0">
                          <label for="Ben_Accname" class="form-label">Beneficiary Acc Name</label>
