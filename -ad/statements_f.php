              ...
              <div class="table-responsive text-nowrap">
                <table class="table card-table table-hover td.dt-control table-striped" id="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    $result = qFieldsOr($con, "statement", "*", $data);
                    $i = 0;
                    if (!$result) {
                    } else {
                    ...
                    ?>
                        ...
                        <tr data="<tr><td>Transaction Description:</td><td><?php echo $Description ?></td></tr>
                            ...
                            <tr><td>Description Details:</td><td><?php echo $Description ?></td></tr>
                            <tr><td>More info:</td><td><?php echo $More_info ?></td></tr>
                            ">
                          ...
                          <td>
                            ...
                            <?php if ($cd_email_stats == "0") { ?>
                              <span class="badge bg-label-danger me-1">Unsent</span>

                            <?php } elseif ($cd_email_stats == "1") { ?>
                          ...
                          <td>
                            ...
                            <?php if ($cd_sms_stats == "0") { ?>
                              <span class="badge bg-label-danger me-1">Unsent</span>

                            <?php } elseif ($cd_sms_stats == "1") { ?>
                              <span class="badge bg-label-info  me-1">Sent</span>
