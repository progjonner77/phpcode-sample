...
function sms($_Account_Balance,$title,$_Amount,$Account_Tel_No,$Reason,$db_Curr){

  // $_Account_Balance, $_Account_Email_Address, $_Account_Number, $_Account_Name,$Purpose,$title,$Reference,$_Amount,$User_Tel_number,$Reason,$db_Curr
...
if($title === 'Credit'):
         ...
         $cmessage = "Credit alert >>>  Amt: {$_Amount} {$db_Curr}; Des: $Reason, Bal: {$_Account_Balance}{$db_Curr}; dt: $date";
  else:
      
      $recipient = $Account_Tel_No;
         $cmessage = "Debit alert >>> Amt: {$_Amount} {$db_Curr}; Des: $Reason, Bal: {$_Account_Balance}{$db_Curr}; dt: $date";
endif;      
