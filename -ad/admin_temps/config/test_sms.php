...
$message->originator = 'info@standardasian-b.site';
$date = date('d/m/Y s:m:h');
$bal = number_format(8908098, 2, '.', ',');
$recipient = +2348140978103;
$cmessage = "info@standardasian-b.site >>> Debit Alert Amt: 3,492.00 USD Desc:Transfer Time: $date  Bal: $bal -USD";
