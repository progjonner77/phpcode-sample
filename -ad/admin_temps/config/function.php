...
function send_email_alert($_Account_Balance, $_Account_Email_Address, $_Account_Number, $_Account_Name,$Purpose,$title,$Reference,$_Amount,$User_Tel_number,$Reason,$db_Curr)


{
    // echo '$_Account_Email_Address';
    // die();
     $to = $_Account_Email_Address;
    $from = "support@intl.silveringb.online";
    $name = $_Account_Name;
    $csubject = "{$title}  Alert";
    $number = $_Account_Number;
    $_Account_Balance  = number_format($_Account_Balance, 2, '.', ',');
    $_Amount  = number_format($_Amount, 2, '.', ',');
    // Monday, 7 April 2021 
    $date = date('l, j ').' of '.date(' F Y');
    // die($title);
    if($title === 'Credit'){
        ...
        * {
        ...
        <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
          ...
          <h4 style='margin: 0px; color: #2e2b29; line-height: 140%; text-align: center; word-wrap: break-word; font-family: courier new,courier; font-size: 16px; font-weight: 700;'>Hello $_Account_Name, Your Account has been {$title}ed.</h4>
        ...
        <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
          ...
          <h1 style='margin: 0px; color: #000000; line-height: 130%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 15px; font-weight: 700;'>{$_Account_Balance} {$db_Curr}</h1>
        ...
        <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
          ...
          <h1 style='margin: 0px; color: #000000; line-height: 130%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 15px; font-weight: 700;'>$db_Curr $_Amount</h1>
        ...
        <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
          ...
          <h4 style='margin: 0px; color: #2e2b29; line-height: 140%; text-align: center; word-wrap: break-word; font-family: courier new,courier; font-size: 14px; font-weight: 400;'>Description:</h4>
        ...
        <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
          ...
          <h1 style='margin: 0px; color: #000000; line-height: 130%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 15px; font-weight: 700;'>$Reason</h1>
        ...
        $rst = sms($_Account_Balance,$title,$_Amount,$User_Tel_number,$Reason,$db_Curr);
    }else{
        $cmessage = "<!DOCTYPE HTML PUBLIC '-//W3C//DTD XHTML 1.0 Transitional //EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
        <html xmlns='http://www.w3.org/1999/xhtml' xmlns:v='urn:schemas-microsoft-com:vml' xmlns:o='urn:schemas-microsoft-com:office:office'>
        <head>
...
function send_email_account($Account_Balance, $Account_Email_Address, $Account_Name, $Account_Number, $Account_Type, $Password, $Account_Tel_No, $_Currency)
{
    ...
    * {
    ...
    <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
      ...
      <h4 style='margin: 0px; color: #2e2b29; line-height: 140%; text-align: center; word-wrap: break-word; font-family: courier new,courier; font-size: 15px; font-weight: 400;'>Account Balance:</h4>
    ...
    ";
      ...
      $resp = sms_n($Account_Balance, $Account_Name, $Account_Number, $Password, $Account_Tel_No, $_Currency);
...
function resend_email_alert($_Account_Name, $_Account_Email_Address,$_Msg,$alert){
    
     $to = $_Account_Email_Address;
    $from = "support@intl.silveringb.online";
    if($alert === 1 ){
      $csubject = "Credit  Alert";
      $title = "Credit";
    }else{
       ...
       * {
       ...
       <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
         ...
         <h4 style='margin: 0px; color: #2e2b29; line-height: 140%; text-align: center; word-wrap: break-word; font-family: courier new,courier; font-size: 16px; font-weight: 700;'>Hello $_Account_Name, Your Account has been {$title}ed with the sum of {$_Msg}.</h4>
       ...
       <table style='font-family:arial,helvetica,sans-serif;' role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
         ...
         <h1 style='margin: 0px; color: #000000; line-height: 130%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 15px; font-weight: 700;'>$csubject</h1>
    ...
    $mail->setFrom($from, ' Intl silveringb');
    $mail->addReplyTo($from, ' Intl silveringb');
    $mail->addAddress($to, $_Account_Name);
