                    ...
                    return (
                        ...
                        (l = [{
                            ...
                            },
                            {
                                ...
                                value: function(e, n) {
                                    for (
                                        var t = e.childNodes, i = [], o = 0, s = t.length; o < s; o++
                                    )
                                        if (t[o].classList) {
                        ...
                        (t = [{
                            ...
                            },
                            {
                                ...
                                value: function(n, t) {
                                    ...
                                    for (
                                        var s = 0, l = (i = i.slice(0, i.indexOf(o))).length; s < l; s++
                                    )
                            ...
                            },
                            {
                                ...
                                get: function() {
                                    for (
                                        var e = this._inner.childNodes, n = 0, t = 0, i = e.length; t < i; t++
                                    )
                                        e[t].tagName &&
