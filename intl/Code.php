	  ...
	  <?php
                        ...
                        <div class="contact-form">
                            <div class="row">
                                <form  method="POST" action="" class="contact-form">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                         <lable class="form-label">Provide the code Given to you</lable>
                                        <input type="number" class="Account-Email-Address form-control" id="Code" placeholder="*******" required data-error="Please enter the code given to you">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                        <button type="submit" id="submit" class="add-btn contact-btn submit">Confirm Code</button>
       ...
       <footer class="footer-1">
        ...
        $(".submit").on('click', function(trigger) {
            ...
            var $_databaseObject = {
                url: "includes/admin/funcs/code.php",
                method: "POST",
                dataType: "json",
                data: _formData,
                error : function(){
                ...
                success: function(data) {
                    if (data.error === 1) {
                     ...
                     var stope_Int = setInterval(() => {
                                     window.location="Account-reg.php";
