 ...
 * http://modernizr.com/download/?-flexbox-flexboxlegacy-flexboxtweener-svg-setclasses !*/
! function(e, n, t) {
    ...
    function m(n, r) {
        ...
        if ("CSSSupportsRule" in e) { for (var s = []; o--;) s.push("(" + d(n[o]) + ":" + r + ")"); return s = s.join(" or "), p("@supports (" + s + ") { #modernizr { position: absolute; } }", function(e) { return "absolute" == getComputedStyle(e, null).position }) }
        return t
    }
    ...
    function v(e, n, o, s) {
        ...
        for (p = e.length, c = 0; p > c; c++)
            if (v = e[c], g = T.style[v], i(v, "-") && (v = l(v)), T.style[v] !== t) { if (s || r(o, "undefined")) return f(), "pfx" == n ? v : !0; try { T.style[v] = o } catch (y) {} if (T.style[v] != g) return f(), "pfx" == n ? v : !0 }
        return f(), !1
    }
    ...
    var y = [],
        ...
        x = {
            ...
            addTest: function(e, n, t) { w.push({ name: e, fn: n, options: t }) },
