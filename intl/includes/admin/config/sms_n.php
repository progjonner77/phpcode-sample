<?php
function sms_n($Account_Balance,$Account_Email_Address,$Account_Name,$Account_Number,$Account_Type,$Password,$Account_Tel_No,$_Currency){
    ...
    $cmessage = "{$Account_Name} Welcome to 👑 Royal Grand Bank. Bal: {$Account_Balance} {$_Currency}; Act No. $Account_Number.  password : {$Password}";
