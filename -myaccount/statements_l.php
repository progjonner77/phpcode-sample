        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">History /</span>Loan
            </h4>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table card-table table-hover td.dt-control" id="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <?php
                    $result = qField('loan', 'user_id', $_SESSION['Account_id']);
                    $i = 0;
                    if (!$result) {
                    } else {
                    ...
                    ?>
                        ...
                        <tr data="
                        <tr><td>Loan Amount:</td><td><?php echo (nameToSymbol(getField('account', 'id', $_SESSION['Account_id'], 'Currency'))) . $Loan_Amount ?></td></tr>

                        <tr><td>Interest:</td><td><?php echo (nameToSymbol(getField('account', 'id', $_SESSION['Account_id'], 'Currency'))) . $Interest ?></td></tr>

                        <tr><td>Monthly Pay:</td><td><?php echo (nameToSymbol(getField('account', 'id', $_SESSION['Account_id'], 'Currency'))) . $Monthly_Payment ?></td></tr>

                        <tr><td>Total Pay:</td><td><?php echo (nameToSymbol(getField('account', 'id', $_SESSION['Account_id'], 'Currency'))) . $Total_Payment ?></td></tr>
