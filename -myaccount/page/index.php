...
<body class="header-fix fix-sidebar">
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-12 row">
                        <div class="col-md-12 col-lg-4">
                            <div class="card profile-card">
                                ...
                                <p class="about"><b><?php echo $email ?></b><br /><?php echo $fund ?> <br> on
                                    <?php echo (getField('pack', 'id', $_SESSION['Account_id'], 'name')) ?></p>
        ...
        <!-- End Container fluid  -->
        <!-- footer -->
        <footer class="footer"> © 2022 CoinBlade All Right Reserved.</footer>
        <!-- End footer -->
    </div>
    <!-- End Page wrapper  -->
    </div>
